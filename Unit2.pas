...
type
  ...
  const   Hpryjka=13; // высота прыжка
implementation
...
// Установка параметров препятствий --------------------------------------------
...
begin
  ...
  // Увеличение скороти и счет кактусов ----------------------------------------
